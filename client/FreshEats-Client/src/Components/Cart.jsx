                                    ...
                                    
                                {
                                    dataList.map((obj,index)=>(
                                        <tr>
                                            ...
                                            <td className="py-4">&#8377; {(obj.price * quantity).toFixed(2)}</td>
                                            <td >

                                                <svg style={{"cursor":"pointer"}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
