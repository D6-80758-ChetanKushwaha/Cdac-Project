                  ...
                  <div class="mt-10 grid grid-cols-2 gap-6 sm:grid-cols-4 sm:gap-4 lg:mt-16">
                    ...
                    <article class="relative flex flex-col overflow-hidden rounded-lg border">
                      <div class="aspect-square overflow-hidden">
                        <img class="h-full w-full object-cover transition-all duration-300 group-hover:scale-125" src="https://componentland.com/images/86WxAQqZpR5CqrhSPKwNv.png" alt="" />
                      </div>
                    ...
                    <article class="relative flex flex-col overflow-hidden rounded-lg border">
                      <div class="aspect-square overflow-hidden">
                        <img class="h-full w-full object-cover transition-all duration-300 group-hover:scale-125" src="https://componentland.com/images/POklWwmmu0AtDZe5tNh9j.png" alt="" />
                      </div>
                    ...
                    <article class="relative flex flex-col overflow-hidden rounded-lg border">
                      <div class="aspect-square overflow-hidden">
                        <img class="h-full w-full object-cover transition-all duration-300 group-hover:scale-125" src="https://componentland.com/images/exH8iOZwkjQekSALkXCZb.png" alt="" />
                      </div>
                    ...
                    <article class="relative flex flex-col overflow-hidden rounded-lg border">
                      <div class="aspect-square overflow-hidden">
                        <img class="h-full w-full object-cover transition-all duration-300 group-hover:scale-125" src="https://componentland.com/images/1DULzCtZvWhr5q5DDT6Ac.png" alt="" />
                      </div>
