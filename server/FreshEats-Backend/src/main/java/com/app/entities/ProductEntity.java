...
public class ProductEntity extends BaseEntity {
     ...
     *  This means that each Product entity would have a reference to its associated Seller,
     *  but the Seller entity would not have a direct reference back to its associated products.
